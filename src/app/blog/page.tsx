...
export const metadata: Metadata = {
  title: "Blog | REXI - Everyday Legal Safety Insights",
  description: "Expert advice on insurance policies, rent agreements, employment documents, and staying safe in your everyday legal life.",
  alternates: {
    canonical: "/blog",
  },
};
