...
export const metadata: Metadata = {
    title: "Compare Health Insurance Plans | REXI — AI Side-by-Side Analysis",
    description:
        "Upload 2–4 health insurance policies and get an AI-powered comparison: room rent limits, co-payments, waiting periods, sub-limits, and real claim scenarios for each plan — so you pick the right one.",
    keywords: [
        "compare health insurance plans India",
        "health insurance comparison",
        "best health insurance India",
        "mediclaim comparison",
        "health insurance AI compare",
    ...
    openGraph: {
        ...
        description: "AI comparison of your health insurance policies. Room rent, waiting periods, sub-limits — see the real difference.",
    ...
    twitter: {
        ...
        description: "Upload 2–4 health policies. REXI's AI tells you which one actually covers you best.",
